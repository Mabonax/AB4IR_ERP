    ...
    public function getOverview(int $id): array
    {
        ...
        return [
            ...
            'stats' => [
                ...
                'active_milestone_templates_count' => (int) $program->milestoneTemplates->where('is_active', true)->count(),
                'required_milestone_templates_count' => (int) $program->milestoneTemplates->where('is_required', true)->count(),
                'projects_using_milestones_count' => (int) $program->projects->filter(fn (Project $project) => $project->milestones->isNotEmpty())->count(),
