...
class MarketingDeliverableResource extends JsonResource
{
    public function toArray($request): array
    {
        ...
        return [
            ...
            'work_task_id' => $this->work_task_id ?? $this->request?->work_task_id,
            'work_task_title' => $this->workTask?->title ?? $this->request?->workTask?->title,
            'work_task_status' => $this->workTask?->status ?? $this->request?->workTask?->status,
