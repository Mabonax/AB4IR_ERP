...
export default function MilestoneTemplatesProgram({
    ...
    templates: { data: MilestoneTemplateRow[] };
}) {
    ...
    const [selectedTemplate, setSelectedTemplate] =
        useState<MilestoneTemplateRow | null>(null);
    ...
    const mappedTemplateData = selectedTemplate
        ? {
              ...
              pass_mark: selectedTemplate.pass_mark ?? '',
              is_required: selectedTemplate.is_required ? '1' : '0',
              is_active: selectedTemplate.is_active ? '1' : '0',
              expected_timing: selectedTemplate.expected_timing ?? '',
          }
        : { program_id: String(program.id), is_required: '1', is_active: '1' };
            ...
            <div className="space-y-4 p-4">
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                    <CustomModelForm
                        ...
                        description={
                            MilestoneTemplateModelFormConfig.description
                        }
