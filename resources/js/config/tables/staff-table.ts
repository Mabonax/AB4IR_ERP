export const StaffTableConfig = {
  columns: [
    { label: "First Name", key: "first_name", className: "px-4 py-2 text-left" },
    { label: "Last Name", key: "last_name", className: "px-4 py-2 text-left" },
    { label: "Email", key: "email", className: "px-4 py-2 text-left" },
    { label: "Phone", key: "phone", className: "px-4 py-2 text-left" },
